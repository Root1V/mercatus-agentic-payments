...
| [RM-18](docs/roadmap.md#rm-18) | Otros rieles de pago (tarjeta emitida por la plataforma, banco propio) | ⬜ Backlog | Tarjetas vía un emisor programático (Stripe Issuing/Marqeta/similar) + banco propio (AIBank); Apple Pay descartado por depender de la identidad de un humano |
