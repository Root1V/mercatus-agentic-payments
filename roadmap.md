...
| [RM-20](docs/roadmap.md#rm-20) | Rebranding del dashboard a "Mercatus" | ✅ Hecho | Título, sidebar, login y favicon con el nombre "Mercatus" y un monograma "M" generado para la ocasión |
