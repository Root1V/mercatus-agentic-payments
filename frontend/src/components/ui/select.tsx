...
// `<select>` nativo estilizado -- no Radix. Para las pocas listas simples de
// este dashboard (protocolo, capacidad) un select nativo es más simple,
// accesible por defecto, y no agrega una dependencia extra.
